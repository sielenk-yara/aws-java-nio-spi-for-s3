 ...
 */
final class S3FileSystemImpl extends S3FileSystem {
    static final Logger logger = LoggerFactory.getLogger(S3FileSystemImpl.class);
    ...
    private final S3FileSystemProviderBase provider;
     ...
     */
    S3FileSystemImpl(S3FileSystemProviderBase provider, S3NioSpiConfiguration config) {
     ...
     */
    @Override
    public S3FileSystemProviderBase provider() {
        return provider;
    }
    ...
    public Iterable<Path> getRootDirectories() {
        return Collections.singleton(S3PathImpl.getPath(this, "/"));
    }
    ...
    @Override
    public S3PathImpl getPath(String first, String... more) {
        return S3PathImpl.getPath(this, first, more);
    }
